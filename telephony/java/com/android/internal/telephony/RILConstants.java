...
*/
    ...
    int RIL_REQUEST_GET_UICC_SUBSCRIPTION = 117;
    int RIL_REQUEST_GET_DATA_SUBSCRIPTION = 118;
    int RIL_REQUEST_SET_TRANSMIT_POWER = 119;
    int RIL_REQUEST_SETUP_QOS = 120;
    int RIL_REQUEST_RELEASE_QOS = 121;
    int RIL_REQUEST_GET_QOS_STATUS = 122;
    int RIL_REQUEST_MODIFY_QOS = 123;
    int RIL_REQUEST_SUSPEND_QOS = 124;
    int RIL_REQUEST_RESUME_QOS = 125;
    int RIL_REQUEST_SYNC_AUDIO = 126;
    int RIL_REQUEST_RESET_CP = 127;
    ...
    int RIL_UNSOL_ON_SS = 1040;
    int RIL_UNSOL_STK_CC_ALPHA_NOTIFY = 1041;

    int RIL_UNSOL_STK_SEND_SMS_RESULT = 11002; /* Samsung STK */
    int RIL_UNSOL_UICC_SUBSCRIPTION_STATUS_CHANGED = 11031;
}
